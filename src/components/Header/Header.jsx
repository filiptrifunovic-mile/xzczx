...
const HeaderCopy = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      // If the click is outside the navigationRef element, close the menus
      if (
  ...
  const handleCategoryMouseEnter = (imageId) => {
  ...
  const handleScroll = () => {
    ...
    setNavHasBg(currentScrollPosition > 0);
  ...
  const toggleMegaMenu = (menuName) => {
    if (megaOpen === menuName) {
      setMegaOpen("");
    } else {
      setMegaOpen(menuName);
    }
  };
  ...
  return (
    <header>
      <nav
        ref={navigationRef}
        className={`navbar js-navigation ${navHidden ? "hidden" : ""} ${
          navHasBg ? "has-bg" : ""
        } ${navOpen ? "open" : ""} ${megaOpen ? "mega-open" : ""}`}
      >
        {/* NAVIGACIJA */}
        <div className="container">
          ...
          <button
            className="navbar-toggle js-navbar-toggle"
            type="button"
            onClick={toggleNav}
          >
          ...
          <div className="navbar-menu">
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <span
                  className="nav-link js-mega-toggle"
                  data-mega="new-bikes"
                  onClick={() => toggleMegaMenu("new-bikes")}
                >
                  <span className="flex">
                    <span className="img">
                      <img
        ...
        <div
          className={`navbar-mega navbar-mega-bikes js-mega-menu ${
            megaOpen === "new-bikes" ? "open" : ""
          }`}
          data-mega="new-bikes"
        >
          <div className="container">
            <div className="back js-mega-close" onClick={closeMegaMenu}>
              New Bikes
            </div>
            <div className="flex">
              <div className="left">
                <div
                  className="category js-mega-category"
                  data-id="1"
                  onMouseEnter={() => handleCategoryMouseEnter("1")}
                ...
                <div
                  className="category js-mega-category"
                  data-id="2"
                  onMouseEnter={() => handleCategoryMouseEnter("2")}
                  onMouseLeave={handleCategoryMouseLeave}
                >
                  <div className="title">
                ...
                <div
                  className="category js-mega-category"
                  data-id="3"
                  onMouseEnter={() => handleCategoryMouseEnter("3")}
                  onMouseLeave={handleCategoryMouseLeave}
                >
                  <div className="title">
                ...
                <div
                  className="category js-mega-category"
                  data-id="4"
                  onMouseEnter={() => handleCategoryMouseEnter("4")}
                  onMouseLeave={handleCategoryMouseLeave}
                >
                  <div className="title">
                ...
                <div
                  className="category js-mega-category"
                  data-id="5"
                  onMouseEnter={() => handleCategoryMouseEnter("5")}
                  onMouseLeave={handleCategoryMouseLeave}
                >
                  <div className="title">
                ...
                <div
                  className="category js-mega-category"
                  data-id="6"
                  onMouseEnter={() => handleCategoryMouseEnter("6")}
                  onMouseLeave={handleCategoryMouseLeave}
                >
                  <div className="title">
            ...
            <div className="flex">
              <div className="left">
                <div className="category">
                  ...
                  <div className="subcategories">
                    <div
                      className="link js-mega-category"
                      data-id="1"
                      onMouseEnter={() => handleCategoryMouseEnter("1")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="7"
                      onMouseEnter={() => handleCategoryMouseEnter("7")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="8"
                      onMouseEnter={() => handleCategoryMouseEnter("8")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="9"
                      onMouseEnter={() => handleCategoryMouseEnter("9")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="10"
                      onMouseEnter={() => handleCategoryMouseEnter("10")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="11"
                      onMouseEnter={() => handleCategoryMouseEnter("11")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="12"
                      onMouseEnter={() => handleCategoryMouseEnter("12")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
                    ...
                    <div
                      className="link js-mega-category"
                      data-id="13"
                      onMouseEnter={() => handleCategoryMouseEnter("13")}
                      onMouseLeave={handleCategoryMouseLeave}
                    >
