...
! function(e, n, t) {
    ...
    function A() {
        ...
        for (var r in u)
            if (u.hasOwnProperty(r)) {
                if (e = [], n = u[r], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length))
                    for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
                for (A = o(n.fn, "function") ? n.fn() : n.fn, a = 0; a < e.length; a++) i = e[a], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = A : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = A), f.push((A ? "" : "no-") + s.join("-"))
            }
    }
    ...
    function l(e, t, o, A) {
        var a, i, l, f, u = "modernizr",
            c = s("div"),
            d = r();
        if (parseInt(o, 10))
            for (; o--;) l = s("div"), l.id = A ? A[o] : u + (o + 1), c.appendChild(l);
        return a = s("style"), a.type = "text/css", a.id = "s" + u, (d.fake ? d : c).appendChild(a), d.appendChild(c), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(n.createTextNode(e)), c.id = u, d.fake && (d.style.background = "", d.style.overflow = "hidden", f = p.style.overflow, p.style.overflow = "hidden", p.appendChild(d)), i = t(c, e), d.fake ? (d.parentNode.removeChild(d), p.style.overflow = f, p.offsetHeight) : c.parentNode.removeChild(c), !!i
    }
    var f = [],
        u = [],
        c = {
    ...
    Modernizr.addTest("touchevents", function() {
        ...
        return t
    }), A(), a(f), delete c.addTest, delete c.addAsyncTest;
